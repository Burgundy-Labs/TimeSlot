...
public class SettingsController extends Controller {
    ...
    public Result createSubscriptionType() {
        if(!UserController.getCurrentRole().equals("Admin")){
            return forbidden(views.html.error_pages.unauthorized.render());
        }
        JsonNode json = request().body().asJson();
        String subscriptionTypeName = json.findPath("subscriptionTypeName").asText();
        //AppointmentTypeModel subscriptionType = new SubscriptionTypeModel( subscriptionTypeId: null, subscriptionTypeName);
        //SettingsDB.addSubscriptionType(subscriptionType);
        return ok();
    }
