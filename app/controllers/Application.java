...
public class Application {
    public static List<MenuLink> menuLinks = Arrays.asList(
            new MenuLink("/Account", "Account", "account_circle", "Manage account settings / preferences."),
            new MenuLink("/Dashboard", "Dashboard", "dashboard", "Something about the dashboard."),
            new MenuLink("/Appointments", "Appointments", "schedule", "View, manage, or cancel your upcoming / past appointments."),
